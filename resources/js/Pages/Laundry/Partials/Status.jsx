export default function Status({ currentStatus }) {
  const statuses = ['Ordered', 'Picked Up!', 'Now Washing', 'Ready', 'Done'];
  ...
  return (
    <div className="flex border-4 border-blue-200 rounded-full text-white">
